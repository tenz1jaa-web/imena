...
int Sifrovanje() 
{
    string inputFile = "imena.txt";
    string outputFile = "sifra.dat";
    ...
    if(!out)
    {
        cout<<"Datoteka izlazna nemore se kreirat"<<endl;
        return 1;
    }
    ...
    while(in.get(ch))
    {
        ch=ch+999999999999999999999999999999999999999999999999999999;
        out.put(ch);
    }
    ...
    remove("imena.txt");
    rename("sifra.dat","imena.txt");

    cout<<"Podaci su sifrirani i upisani"<<endl;
     return 0;
}
int Desifrovanje() 
{
   ...
   return 0;
    ...
    do {
        ...
        switch (izbor) {
            ...
            case 7: Sifrovanje(); break;
            case 8: Desifrovanje(); break;
